...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [683015.479453, 2760069.870537, 687510.226853, 2766419.761321], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32638',
            //extent: [683122.497248, 2760864.549329, 687573.802326, 2765650.996218],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([683015.479453, 2760069.870537, 687510.226853, 2766419.761321], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">FURSAN 2 TEST STATUS WEEKLY REPORT</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (142 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Weekly report showing the current status and progress of all testing activities for the FURSAN project, including completed and pending tests.';
            }
